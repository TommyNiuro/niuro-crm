      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="deal-contact" className="cursor-pointer">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => {
                  if (!v) return;
                  setValue("stageId", v);
                  const stageName = stagesList.find((s) => s.id === v)?.name;
                  if (stageName && STAGE_CFG[stageName]?.probability != null) {
                    setValue("probability", String(STAGE_CFG[stageName].probability));
                  }
                }}
              >
                <SelectTrigger id="deal-stage" className="cursor-pointer">
            ...
            <div className="space-y-2">
              ...
              <Input id="deal-close" type="date" {...register("expectedClose")} />
            </div>
          </div>
